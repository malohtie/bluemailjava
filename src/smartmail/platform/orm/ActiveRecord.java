...
public class ActiveRecord {
    ...
    public void load() {
        Object primaryValue;
        if (!this.primary.isEmpty() && (primaryValue = getFieldValue(String.valueOf(this.primary.get("field")))) != null)
            ...
            if (!this.primary.isEmpty()) {
                ...
                if (value == null || Integer.parseInt(String.valueOf(value)) == 0) {
                    if ("pgsql".equalsIgnoreCase(Database.get(this.database).getDriver())) {
                        ...
                        if (!nextVal.isEmpty() && ((LinkedHashMap)nextVal.get(0)).containsKey("nextval"))
    ...
    public static ActiveRecord first(Class subClass, String condition, Object[] values) {
        ...
        try {
            ...
            if ((row = queryBuilder.first()) != null && !row.isEmpty()) {
    ...
    public static List all(Class subClass, String condition, Object[] values) {
        ...
        try {
            ...
            if ((rows = queryBuilder.order(new String[] { String.valueOf(outerObject.getPrimary().get("name")) }, "ASC").all()) != null && !rows.isEmpty())
